...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'rules' => ['required', 'file', 'max:102400'],        // 100MB temp-upload cap (matches php.ini + web-server body limit)
    ...
    */
    ...
    'payload' => [
        'max_size' => 1024 * 1024 * 100,   // 100MB - max request payload (raised for large form saves / rich editor content)
