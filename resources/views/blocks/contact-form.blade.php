            <div class="container contact-one__container">
                <div class="contact-one__wrapper">
                    <form class="form-one contact-one__form contact-form-validated" action="https://formsubmit.co/info@novi-agro.com" method="POST">
                        <input type="text" name="_honey" style="display:none" tabindex="-1" autocomplete="off">
                        <input type="hidden" name="_subject" value="New Contact Form Submission - Novi Agro">
